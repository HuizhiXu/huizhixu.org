...
$$K\_{ij} = k(x_i,x_j) = \sigma_f^2e^{-\frac{1}{2l^2}\|\|X_i-X_j\|\|^2}$$
2.  略(以后补充，暂时不是重点)
...
已知先验知识：$p(f\_\*(x_4)\|x_4) = N(f\_\*(x_4)\|0, k(x_4,x_4))$ 和 $p(f\|x) = N(f\|0,K)$，求后验概率$p(f\_\*(x_4)\|x_4,x,f)$。
...
$$ p(f\_\*(x_4)\|x_4,x,f) = N(f\_\*(x_4)\|\mu_4, \Sigma_4)$$

$$ \mu_4 = K_4^TK_y^{-1}f$$

$$ \Sigma_4 = K\_{44} - K_4^TK_y^{-1}K\_{4}$$
